...
:::image type="content" source="./media/oracle-migration/odaa-rman-direct-migration-scenario-2.png" alt-text="Diagram shows the RMAN backup and restore approach by using a nfs share."lightbox="./media/oracle-migration/odaa-rman-direct-migration-scenario-2.png":::
