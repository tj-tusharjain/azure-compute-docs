...
>>
> GRID Driver 17.3 is only supported on NCasT4_v3 series of VMs as of now. Please use this [link](https://download.microsoft.com/download/7/e/c/7ec792c9-3654-4f78-b1a0-41a48e10ca6d/NVIDIA-Linux-x86_64-550.127.05-grid-azure.run) to download and install it manually. We have licensing issues on the NVv5 A10 series and Azure is actively working with Nvidia to resolve it. Extension currently installs 16.5 GRID drivers.
